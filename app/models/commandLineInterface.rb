class CommandLineInterface
  ...
  def getName
    ...
    user_name = prompt.ask('What is your name?').capitalize
  ...
  def exit
    ...
    puts "                                                                              - JK Rowling"
    File.open('art/picture3').each do |line|
      puts line
    end
    sleep 7
    system("^C")
  ...
  def greet
    system("clear")
    File.open('art/picture2').each do |line|
      puts line
    end
    puts ""
    puts ""
  ...
  def decideHouse(house)
    hs_name = House.find_by(house_name: "#{house.capitalize}")
    Quiz.create(student_id: @student.id, house_id: hs_name.id)
  end

  def assignHouse
    File.open('art/picture1').each do |line|
      puts line
    end
    puts ""
  ...
  def deleteQuiz
    ...
    if quizzes == []
      system("clear")
      puts "You don\'t have any quizzes!".bold
      puts ""
    elsif quizzes != []
